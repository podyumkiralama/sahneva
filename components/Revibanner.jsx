  ...
  const Content = () => (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        <p className="text-sm sm:text-base font-semibold text-neutral-900">{title}</p>
        <p className="text-xs sm:text-sm text-neutral-600">{subtitle}</p>
      </div>

      <div className="flex-1" />

      {/* Koyu amber (#b45309) üstünde beyaz → yüksek kontrast */}
      <a
        href={REVIEW_URL}
        target="_blank"

    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[340px] flex items-center justify-center bg-neutral-900 text-white">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-neutral-200">
            ...
            etkinlik için ses ve ışık sistemleri çözümleri.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12 max-w-5xl">
        ...
        <p className="leading-relaxed text-neutral-800">
          Ses kurulumunda, sahne önü ve arkası hoparlör konumları yankı, rüzgâr
          yönü, seyirci yoğunluğu gibi unsurlara göre planlanır. Böylece her
          noktada eşit ses dağılımı sağlanır.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-12 max-w-5xl">
        <h2 className="text-2xl font-semibold mb-4">
          💡 Işık Sistemleri ve Sahne Atmosferi
        </h2>
        ...
        <p className="leading-relaxed text-neutral-800">
          Düğünlerde genellikle sahne ve dans pisti çevresine dekoratif ışıklar
          yerleştirilirken, kurumsal lansmanlarda logo aydınlatması ve spot
          vurgular öne çıkar. Konserlerde ise yoğun beam, robot ışık ve efekt
          kombinasyonları tercih edilir.
        </p>
      </section>

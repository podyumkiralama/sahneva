...
// Bu sayfa sadece "led-ekran" hizmeti için statik rota: /led-ekran-kiralama
const svc = getService("led-ekran");

const CONTENT = {
  heroOverlay: true,
  // Galeriye kendi görsellerini /public/img/led/ içine koy
  gallery: ["/img/led/1.webp", "/img/led/2.webp", "/img/led/3.webp"],
  packages: [
    {
      name: "İç Mekân Paket — P3 • 3×2 m",
      includes: [
        "P3 iç mekân paneller (yaklaşık 6 m²)",
    ...
    },
    {
      ...
      includes: [
        "P4 dış mekân paneller (yaklaşık 10 m²)",
    ...
    },
    {
      ...
      includes: [
        "P3.9 dış/iç mekân uyumlu paneller (≈ 21 m²)",
        "1920–3840 Hz tazeleme, kamera yayınına uygun",
...
export const metadata = {
  title: `${svc?.title ?? "LED Ekran Kiralama"} | Sahneva`,
  description:
    svc?.excerpt ||
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      { url: svc?.img ?? "/img/hizmet-led-ekran.webp" }, // OG fallback garanti
    ],
  },
};

// (Opsiyonel) ISR: içerik düzeltmelerini hızlı yansıtmak için
    ...
    <section className="container max-w-4xl mx-auto py-10 md:py-14 space-y-10">
      ...
      <article className="rounded-2xl border bg-white p-6">
        ...
        <ul className="mt-4 grid gap-2 md:grid-cols-2 text-neutral-800">
          <li className="flex gap-2">
            ...
            <strong>Alan ölçüsü</strong> (m²) ve piksel aralığı (P2–P6)
          </li>
          <li className="flex gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-primary" />
            <strong>İç/dış mekân</strong> ve parlaklık (nit) gereksinimi
          </li>
          <li className="flex gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-primary" />
            <strong>Kurulum yöntemi</strong> (rigging/ground stack) ve truss ihtiyacı
          </li>
          <li className="flex gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-primary" />
            <strong>İçerik ve yayın</strong> (canlı kamera, miksaj, medya sunucu, operatör)
          </li>
          <li className="flex gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-primary" />
            <strong>Güç & lojistik</strong> (besleme hatları, nakliye, gece çalışma)
          </li>
          <li className="flex gap-2">
            <span className="mt-2 h-2 w-2 rounded-full bg-primary" />
            <strong>Süre</strong> (tek gün / çok gün) ve yedek ekipman ihtiyacı
          </li>
        </ul>
        <div className="mt-5 rounded-xl bg-neutral-50 p-4 text-neutral-700">
          <p>
            Hızlı bir bütçe için; <strong>ölçü</strong> (en×boy metre), <strong>mekân türü</strong>{" "}
            (iç/dış), <strong>izleme mesafesi</strong>, <strong>kurulum şekli</strong> ve{" "}
            <strong>tarih/konum</strong> bilgilerini iletmeniz yeterli.
          </p>
        </div>
      </article>
      ...
      <article className="rounded-2xl border bg-white p-6">
        <h2 className="text-2xl md:text-3xl font-extrabold">
          Doğru LED Ekran Seçimi ve Kurulum İpuçları
        </h2>
        ...
        <div className="mt-4 grid gap-6 md:grid-cols-2">
          <div>
            ...
            <ul className="mt-2 space-y-1 text-neutral-800">
              <li>
                • <strong>Piksel aralığı</strong>: Yakın izleme için düşük pitch (P2–P3), uzak
                izleme için P3.9–P6 uygundur.
              </li>
              <li>
                • <strong>İzleme mesafesi kuralı</strong>: Minimum mesafe ≈ pitch(mm) ×{" "}
                <span className="whitespace-nowrap">1–1.5 m</span>.
              </li>
              <li>
                • <strong>Tazeleme (refresh)</strong>: 1920–3840 Hz; kamera çekimlerinde titreşimsiz
                görüntü için önemli.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-neutral-800">
              <li>
                • <strong>Parlaklık (nit)</strong>: İç mekân 800–1500 nit, dış mekân 3500–6500+ nit.
              </li>
              <li>
                • <strong>IP sınıfı</strong>: Dış mekân için en az IP65 (ön yüz) / IP54 (arka yüz).
              </li>
              <li>
                • <strong>Montaj</strong>: Ground stack veya rigging (truss). Rüzgâr ve yük
                hesaplarıyla güvenlik devreleri şart.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-neutral-800">
              <li>• Tipik tüketim: iç mekân 300–500 W/m², dış mekân 500–800 W/m²</li>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="[&>tr>*]:p-2 [&>tr]:border-b">
              <tr>
                <td>Piksel Aralığı</td>
                <td>P2 – P6 (iç/dış mekân)</td>
              </tr>
              <tr>
                <td>Parlaklık (Nit)</td>
                <td>İç: 800–1500 • Dış: 3500–6500+</td>
              </tr>
              <tr>
                <td>Tazeleme Hızı</td>
                <td>≥ 1920 Hz (kamera yayınına uygun 3840 Hz opsiyonel)</td>
              </tr>
              <tr>
                <td>IP Koruma</td>
                <td>Dış: IP65 (ön) / IP54 (arka) • İç: IP43+</td>
              </tr>
              <tr>
                <td>Kabin Ölçüleri</td>
                <td>500×500 mm / 500×1000 mm (manyetik/quick lock)</td>
              </tr>
              <tr>
                <td>Montaj</td>
                <td>Ground stack veya rigging (truss)</td>
              </tr>
              <tr>
                <td>Güç Tüketimi</td>
                <td>İç: ~300–500 W/m² • Dış: ~500–800 W/m² (tipik)</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default function Page() {
  ...
  // HERO görseli: svc.img varsa onu, yoksa /img/hizmet-led-ekran.webp kullan.
      ...
      {!!CONTENT.gallery.length && (
        <section className="container py-8">
          ...
          <p className="mt-3 text-sm text-neutral-500">
            Not: Görselleri <code>/public/img/led/</code> klasörüne ekleyin.
          </p>
        </section>
      )}

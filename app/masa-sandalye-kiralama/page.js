...
// Statik rota: /masa-sandalye-kiralama
...
export const metadata = {
  ...
  keywords: [
    ...
    "bistro kokteyl masası",
    "masa örtüsü kılıf kiralama",
    "İstanbul masa sandalye kiralama",
  ],
  openGraph: {
    title: `${svc?.title ?? "Masa & Sandalye Kiralama"} | Sahneva`,
    description:
    ...
    type: "article",
    images: [{ url: svc?.img ?? "/img/sandalye/og.webp" }],
  },
};

// ISR: küçük içerik düzeltmeleri hızlı yansısın
  ...
  return (
    <section className="container max-w-4xl mx-auto py-10 md:py-14 space-y-10">
      ...
      <article className="space-y-4 text-neutral-800 leading-relaxed">
        ...
        <p>
          Bir etkinliğin akışı sadece sahneyle değil, <strong>oturma konforu ve düzeniyle</strong> de
          şekillenir. <strong>Sahneva</strong> olarak düğün, gala, konferans ve kokteyl gibi farklı
          senaryolara uygun masa–sandalye çözümlerini; <em>teslimat, kurulum ve toplama</em> dâhil
          anahtar teslim sunuyoruz. Envanterimizde Napolyon, konferans tipi ve bistro sandalyeler;
          yuvarlak banket (Ø180 cm), dikdörtgen (180×75 cm) ve kokteyl bistro masaları bulunur.
          Örtü, kılıf, runner ve numaralandırma gibi detaylarla alan estetiğini tamamlarız.
        </p>
      </article>
      ...
      <article className="rounded-2xl border bg-white p-6">
        ...
        <p className="mt-3 text-neutral-700">Fiyatlar adet ve modele göre değişir; aşağıdaki parametreler bütçeyi belirler:</p>
        <ul className="mt-4 grid gap-2 md:grid-cols-2 text-neutral-800">
          <li className="flex gap-2"><span aria-hidden className="mt-2 h-2 w-2 rounded-full bg-primary" />Toplam adet ve etkinlik süresi (tek/çok gün)</li>
          <li className="flex gap-2"><span aria-hidden className="mt-2 h-2 w-2 rounded-full bg-primary" />Model/kaplama seçimi (Napolyon, konferans, bistro, örtü/kılıf)</li>
          <li className="flex gap-2"><span aria-hidden className="mt-2 h-2 w-2 rounded-full bg-primary" />Teslimat mesafesi, kat/erişim ve zaman penceresi</li>
          <li className="flex gap-2"><span aria-hidden className="mt-2 h-2 w-2 rounded-full bg-primary" />Yerleşim planı, numaralandırma ve ekstra personel ihtiyacı</li>
        </ul>
        <div className="mt-5 rounded-xl bg-neutral-50 p-4 text-neutral-700">
          <p>
            Hızlı bir teklif için; <strong>etkinlik tarihi/konumu</strong>, <strong>adetler</strong>,{" "}
            <strong>model</strong> ve varsa <strong>örtü–kılıf</strong> rengini paylaşmanız yeterli.
          </p>
        </div>
      </article>
      ...
      <article className="rounded-2xl border bg-white p-6">
        ...
        <div className="mt-5 rounded-xl bg-neutral-50 p-4 text-neutral-700">
          <p><strong>İpucu:</strong> Kokteyl alanlarında bistro masalarını 2,5–3 m aralıklarla konumlandırmak akışı rahatlatır; renkli kılıflar/şal ile kurumsal kimlik vurgulanabilir.</p>
        </div>
      </article>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="[&>tr>*]:p-2 [&>tr]:border-b">
              ...
              <tr><td>Konferans Sandalyesi</td><td>Yastıklı, istiflenebilir</td><td>Numaralandırma/sıra ayracı ops.</td></tr>
              <tr><td>Örtü & Kılıf</td><td>Keten, tafta, strech kılıf</td><td>Runner, fırfır, şal</td></tr>
            </tbody>
          </table>
        </div>
      </article>
...
export default function Page() {
  ...
  const heroSrc = svc?.img ?? "/img/sandalye/hero.webp";
    ...
    <>
      ...
      <section className="container pb-14">
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-6 text-center text-white md:flex-row md:p-8 md:text-left">
          <h2 className="text-xl font-bold md:text-2xl">{title} için hızlı teklif ister misiniz?</h2>
          <div className="flex justify-center gap-3 md:justify-end">
            ...
            <a
              href={`https://wa.me/905453048671?text=Merhaba%20Sahneva%2C%20${encodeURIComponent(title)}%20hizmeti%20i%C3%A7in%20teklif%20almak%20istiyorum.`}
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg border border-white px-4 py-2 font-semibold hover:bg-white/20 focus-visible:ring-2 focus-visible:ring-white/90 focus-visible:outline-none"
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Napolyon, konferans ve bistro sandalye; banket ve dikdörtgen masalar. Örtü-kılıf, numaralandırma ve profesyonel yerleşim.",
      ...
      />
      <Script
        id="ld-breadcrumb-masa-sandalye"
        type="application/ld+json"
        strategy="afterInteractive"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({

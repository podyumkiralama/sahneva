...
// Dinamik yüklenen (client) bileşenler — ssr:false KULLANMIYORUZ
...
export default function HomePage() {
  return (
    // Not: <main> etiketi layout.js içinde. Burada yalnızca sarmal <div> kullanıyoruz.

...
// Not:
// - Var olan alanlar (slug, title, excerpt, img, desc) aynı kaldı.
// - ogImage/keywords/faqs opsiyoneldir; kullanılmadığında hiçbir şeyi bozmaz.
// - Image path'lerini mevcut projedeki dosya adlarınıza göre bıraktım.
//   (Değiştirmek isterseniz yalnızca img/ogImage yollarını güncelleyin.)
